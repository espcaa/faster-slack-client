...
var call = newRuntimeCaller(objectNames.System);
...
function IsLinux() {
  var _a2, _b;
  return ((_b = (_a2 = window._wails) === null || _a2 === void 0 ? void 0 : _a2.environment) === null || _b === void 0 ? void 0 : _b.OS) === "linux";
}
function IsMac() {
  var _a2, _b;
  return ((_b = (_a2 = window._wails) === null || _a2 === void 0 ? void 0 : _a2.environment) === null || _b === void 0 ? void 0 : _b.OS) === "darwin";
}
function IsAMD64() {
  var _a2, _b;
  return ((_b = (_a2 = window._wails) === null || _a2 === void 0 ? void 0 : _a2.environment) === null || _b === void 0 ? void 0 : _b.Arch) === "amd64";
}
function IsARM() {
  var _a2, _b;
  return ((_b = (_a2 = window._wails) === null || _a2 === void 0 ? void 0 : _a2.environment) === null || _b === void 0 ? void 0 : _b.Arch) === "arm";
}
function IsARM64() {
  var _a2, _b;
  return ((_b = (_a2 = window._wails) === null || _a2 === void 0 ? void 0 : _a2.environment) === null || _b === void 0 ? void 0 : _b.Arch) === "arm64";
}
function IsDebug() {
  var _a2, _b;
...
var call2 = newRuntimeCaller(objectNames.ContextMenu);
...
var call3 = newRuntimeCaller(objectNames.Application);
var HideMethod = 0;
var ShowMethod = 1;
var QuitMethod = 2;
function Hide() {
...
var call4 = newRuntimeCaller(objectNames.Browser);
var BrowserOpenURL = 0;
function OpenURL(url) {
  return call4(BrowserOpenURL, { url: url.toString() });
}
...
var CancellablePromise = class _CancellablePromise extends Promise {
   ...
   */
    ...
    return this.then((value) => _CancellablePromise.resolve(onfinally()).then(() => value), (reason) => _CancellablePromise.resolve(onfinally()).then(() => {
      throw reason;
    }), oncancelled);
  }
  /**
...
// node_modules/@wailsio/runtime/dist/calls.js
window._wails = window._wails || {};
var call5 = newRuntimeCaller(objectNames.Call);
...
function Call(options) {
  ...
  const request = call5(CallBinding, Object.assign({ "call-id": id }, options));
  let running = true;
  request.then((res) => {
    running = false;
...
var call6 = newRuntimeCaller(objectNames.Clipboard);
...
window._wails = window._wails || {};
var call7 = newRuntimeCaller(objectNames.Dialog);
var DialogInfo = 0;
var DialogWarning = 1;
var DialogError = 2;
...
var call8 = newRuntimeCaller(objectNames.Events);
var EmitMethod = 0;
...
function Emit(name, data) {
  return call8(EmitMethod, new WailsEvent(name, data));
}
...
// node_modules/@wailsio/runtime/dist/ios.js
var ios_exports = {};
...
var Window = class _Window {
   ...
   */
  Hide() {
    return this[callerSym](HideMethod2);
  }
  /**
   ...
   */
  Show() {
    return this[callerSym](ShowMethod2);
  }
  /**
