...
function createRoot(fn, detachedOwner) {
  const listener = Listener$1, owner = Owner, unowned = fn.length === 0, current = detachedOwner === void 0 ? owner : detachedOwner, root2 = unowned ? UNOWNED : {
    owned: null,
    cleanups: null,
...
function runComputation(node, value, time) {
  let nextValue;
  const owner = Owner, listener = Listener$1;
...
var _tmpl$ = /* @__PURE__ */ template(`<div class=container><div><a data-wml-openurl=https://wails.io><img src=/wails.png class=logo alt="Wails logo"></a><a data-wml-openurl=https://solidjs.com><img src=/solid.svg class="logo solid"alt="Solid logo"></a></div><h1>Wails + Solid</h1><div aria-label=result class=result></div><div class=card><div class=input-box><input aria-label=input class=input type=text autocomplete=off><button aria-label=greet-btn class=btn>Greet</button></div></div><div class=footer><div><p>Click on the Wails logo to learn more</p></div><div><p>`);
function App() {
  ...
  return (() => {
    var _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.nextSibling, _el$9 = _el$5.nextSibling, _el$0 = _el$9.firstChild, _el$1 = _el$0.nextSibling, _el$10 = _el$1.firstChild;
    insert(_el$4, result);
